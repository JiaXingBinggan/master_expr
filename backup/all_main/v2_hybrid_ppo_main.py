...
def get_model(action_nums, feature_nums, field_nums, latent_dims, batch_size, init_lr_c, init_lr_a, memory_size, device, campaign_id):
...
def main(data_path, dataset_name, campaign_id, latent_dims, model_name, init_lr_c, init_lr_a, end_lr, epoch, batch_size, device, save_param_dir):
    ...
    rl_model = get_model(model_dict_len, feature_nums, field_nums, latent_dims, batch_size,
                         init_lr_c, init_lr_a, memory_size, device, campaign_id)
